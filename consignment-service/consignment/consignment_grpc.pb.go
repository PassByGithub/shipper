...
type ShippingServiceClient interface {
	...
	GetConsignmentList(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *shippingServiceClient) CreateConsignment(ctx context.Context, in *Consignment, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/consigntment.ShippingService/CreateConsignment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shippingServiceClient) GetConsignmentList(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/consigntment.ShippingService/GetConsignmentList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShippingServiceServer interface {
	...
	GetConsignmentList(context.Context, *GetRequest) (*Response, error)
...
func (UnimplementedShippingServiceServer) GetConsignmentList(context.Context, *GetRequest) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetConsignmentList not implemented")
}
...
func _ShippingService_CreateConsignment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/consigntment.ShippingService/CreateConsignment",
	}
...
func _ShippingService_GetConsignmentList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShippingServiceServer).GetConsignmentList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/consigntment.ShippingService/GetConsignmentList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingServiceServer).GetConsignmentList(ctx, req.(*GetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ShippingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "consigntment.ShippingService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetConsignmentList",
			Handler:    _ShippingService_GetConsignmentList_Handler,
		},
	},
