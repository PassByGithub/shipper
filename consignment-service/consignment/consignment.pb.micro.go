...
type ShippingService interface {
	...
	GetConsignmentList(ctx context.Context, in *GetRequest, opts ...client.CallOption) (*Response, error)
}
...
func (c *shippingService) GetConsignmentList(ctx context.Context, in *GetRequest, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "ShippingService.GetConsignmentList", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func RegisterShippingServiceHandler(s server.Server, hdlr ShippingServiceHandler, opts ...server.HandlerOption) error {
	type shippingService interface {
		...
		GetConsignmentList(ctx context.Context, in *GetRequest, out *Response) error
	}
	type ShippingService struct {
		shippingService
	}
...
func (h *shippingServiceHandler) GetConsignmentList(ctx context.Context, in *GetRequest, out *Response) error {
	return h.ShippingServiceHandler.GetConsignmentList(ctx, in, out)
}
